# Bitmax | API Document <a name="0"></a>
==============================================
...
- [Product Symbols](#1)
- [Public API's](#2)
    - [List of all assets](#3)
    - [List all products](#4)
    - [Get Current Trading Fees](#5)
    - [Market Quote (Level 1 Order Book Data) of One Product](#6)
    - [Market Depth (Level 2 Order Book Data) of One Product](#7)
    - [Market Trades](#8)
    - [24-hour Rolling Statistics of All Products](#9)
    - [24-hour Rolling Statistics of one Product](#10)
    - [Bar History](#11)
    - [Bar History Info](#12)
    - [Bar History Data](#13)
- [Authenticated REST API's](#14)
    - [Authentication](#15)
    - [API Entry Point](#16)
    - [API Calls with Input Data](#17)
    - [User Info (`api_path=user/info`)](#18)
    - [List all Balances (`api_path=balance`)](#19)
    - [Get Balance of one Asset (`api_path=balance`)](#20)
    - [Get Deposit/Withdraw History (`api_path=transaction`)](#21)
    - [Orders](#22)
    - [Stages of an Order's Life Cycle](#23)
    - [Place a New Order (`api_path=order`)](#24)
    - [Placing Multiple Orders (`api_path=order/batch`)  (comming soon)](#25)
    - [Cancel an Order (`api_path=order`)](#26)
    - [Cancel Multiple Orders (`api_path=order/batch`)  (comming soon)](#27)
    - [Cancel All Open Orders (`api_path=order/all`)](#28)
    - [Cancel All Open Orders of a Symbol (`api_path=order/all`)](#29)
    - [List of All Open Orders (`api_path=order/open`)](#30)
    - [List Historical Orders (`api_path=order/history`)](#31)
    - [Get Basic Order Data of One Order (`api_path=order`)](#32)
    - [Get Fills of One Order (`api_path=order/fills`)](#33)
    - [Get Deposit address of one Asset (`api_path=deposit`)](#34)
    - [Request withdrawal of one Asset (`api_path=withdraw`)](#35)
- [WebSocket API](#36)
    - [Websocket Authentication](#37)
    - [Subscribe to WebSocket Streams](#38)
    - [Market depth](#39)
    - [Market Trades](#40)
    - [Market Summary](#41)
    - [Bar Chart Data](#42)
    - [Order Management](#43)
    - [Order updates](#44)
    - [Place a New Order with WebSocket](#45)
    - [Cancel an Order with WebSocket](#46)

Basics
---------------------------------------------

### Product Symbols <a name="1"></a>
[back to top](#0)

The exchange adopted the format `baseAssetCode/quoteAssetCode` for product symbols. For instance, `ETH/BTC = 0.052` means the price of 1 `ETH` is 0.052 `BTC`. Although not required,
it is recommended to use `ETH-BTC` in API paths to avoid polluting the path string.


Public RESTful APIs <a name="2"></a>
----------------------------------------------
...
### Get Current Trading Fees <a name="5"></a>
[back to top](#0)
...
### Market Quote (Level 1 Order Book Data) of One Product <a name="6"></a>
[back to top](#0)
...
### Market Depth (Level 2 Order Book Data) of One Product <a name="7"></a>
[back to top](#0)
...
### 24-hour Rolling Statistics of All Products <a name="9"></a>
[back to top](#0)
...
### 24-hour Rolling Statistics of one Product <a name="10"></a>
[back to top](#0)
...
### Bar History <a name="11"></a>
[back to top](#0)

#### Bar History Info <a name="12"></a>
[back to top](#0)
...
Authenticated RESTful APIs  <a name="14"></a>
----------------------------------------------
...
### API Calls with Input Data <a name="17"></a>
[back to top](#0)
...
### User Info (`api_path=user/info`) <a name="18"></a>
[back to top](#0)
...
### List all Balances (`api_path=balance`) <a name="19"></a>
[back to top](#0)
...
### Get Balance of one Asset (`api_path=balance`) <a name="20"></a>
[back to top](#0)
...
### Get Deposit/Withdraw History (`api_path=transaction`) <a name="21"></a>
[back to top](#0)
...
#### Stages of an Order's Life Cycle <a name="23"></a>
[back to top](#0)
...
#### Place a New Order (`api_path=order`) <a name="24"></a>
[back to top](#0)
...
#### Placing Multiple Orders (`api_path=order/batch`)  (comming soon) <a name="25"></a>
[back to top](#0)
...
#### Cancel an Order (`api_path=order`) <a name="26"></a>
[back to top](#0)
...
#### Cancel Multiple Orders (`api_path=order/batch`)  (comming soon) <a name="27"></a>
[back to top](#0)
...
#### Cancel All Open Orders (`api_path=order/all`) <a name="28"></a>
[back to top](#0)
...
#### Cancel All Open Orders of a Symbol (`api_path=order/all`) <a name="29"></a>
[back to top](#0)
...
#### List of All Open Orders (`api_path=order/open`) <a name="30"></a>
[back to top](#0)
...
### List Historical Orders (`api_path=order/history`) <a name="31"></a>
[back to top](#0)
...
#### Get Basic Order Data of One Order (`api_path=order`) <a name="32"></a>
[back to top](#0)
...
#### Get Fills of One Order (`api_path=order/fills`) <a name="33"></a>
[back to top](#0)
...
### Get Deposit address of one Asset (`api_path=deposit`) <a name="34"></a>
[back to top](#0)
...
### Request withdrawal of one Asset (`api_path=withdraw`) <a name="35"></a>
[back to top](#0)
...
### Websocket Authentication <a name="37"></a>
[back to top](#0)
...
### Subscribe to WebSocket Streams <a name="38"></a>
[back to top](#0)
...
### Market Summary <a name="41"></a>
[back to top](#0)

Each market summary data record contains current information about a single product. The data is streamed in batches - we stream market data of all products every 30 seconds.
...
Since only new order updates will be streamed, it is recommended that you load the initial snap of all you orders
using the RESTful API `GET api/v1/order/open`.


#### Place a New Order with WebSocket <a name="45"></a>
[back to top](#0)
...
#### Cancel an Order with WebSocket <a name="46"></a>
[back to top](#0)
